...
// RemoveUserProject mocks base method.
func (m *MockStore) RemoveUserProject(arg0 context.Context, arg1 db.RemoveUserProjectParams) (db.UserProject, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RemoveUserProject", arg0, arg1)
	ret0, _ := ret[0].(db.UserProject)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// RemoveUserProject indicates an expected call of RemoveUserProject.
func (mr *MockStoreMockRecorder) RemoveUserProject(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemoveUserProject", reflect.TypeOf((*MockStore)(nil).RemoveUserProject), arg0, arg1)
}
