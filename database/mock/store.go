...
//
//	mockgen -package mock_db -destination=database/mock/store.go github.com/mindersec/minder/internal/db Store
//
...
// InsertEvaluationOutput mocks base method.
func (m *MockStore) InsertEvaluationOutput(ctx context.Context, arg db.InsertEvaluationOutputParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InsertEvaluationOutput", ctx, arg)
	ret0, _ := ret[0].(error)
	return ret0
}

// InsertEvaluationOutput indicates an expected call of InsertEvaluationOutput.
func (mr *MockStoreMockRecorder) InsertEvaluationOutput(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InsertEvaluationOutput", reflect.TypeOf((*MockStore)(nil).InsertEvaluationOutput), ctx, arg)
}
