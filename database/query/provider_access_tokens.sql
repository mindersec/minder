...
INSERT INTO provider_access_tokens (group_id, provider, encrypted_token, expiration_time) VALUES ($1, $2, $3, $4) ON CONFLICT (provider, group_id) DO UPDATE SET encrypted_token = $3, expiration_time = $4, updated_at = NOW() RETURNING *;
