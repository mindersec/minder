...
-- Note that this migration was originally rolled out and had to be reverted
-- due to a bug. The bug was fixed in this PR: https://github.com/stacklok/minder/pull/4124
-- After fixing this bug, we need to redo part of migration #88 to fix the rows
-- affected by the bug.
