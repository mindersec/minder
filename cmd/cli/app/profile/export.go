...
func exportCommand(cmd *cobra.Command, _ []string) error {
	...
	profileClient, closeProf, err := cli.GetCLIClient(cmd, minderv1.NewProfileServiceClient)
	if err != nil {
	...
	rulesClient, closeRules, err := cli.GetCLIClient(cmd, minderv1.NewRuleTypeServiceClient)
	if err != nil {
	...
	datasourceClient, closeDS, err := cli.GetCLIClient(cmd, minderv1.NewDataSourceServiceClient)
	if err != nil {
