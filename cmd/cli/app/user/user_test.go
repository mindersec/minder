...
func TestCobraMain(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedOutput: "user called\n",
		},
		{
			name:           "user list command",
			args:           []string{"user", "list", "--help"},
			expectedOutput: "user list called\n",
		},
		{
			name:           "user delete command",
			args:           []string{"user", "delete", "--help"},
			expectedOutput: "user delete called\n",
		},
		{
			name:           "user create command",
			args:           []string{"user", "create", "--help"},
			expectedOutput: "user create called\n",
		},
	}
