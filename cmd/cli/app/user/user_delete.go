...
var user_deleteCmd = &cobra.Command{
	Use:   "delete",
	Short: "Delete a user within the mediator controlplane",
	Long: `The medctl user delete subcommand lets you delete users within the
mediator controlplane.`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("user delete called")
	},
}
