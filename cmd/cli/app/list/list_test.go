...
func TestCobraMain(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedOutput: "list called\n",
		},
		{
			name:           "list group command",
			args:           []string{"list", "group", "--help"},
			expectedOutput: "list group called\n",
		},
		{
			name:           "list org command",
			args:           []string{"list", "org", "--help"},
			expectedOutput: "list org called\n",
		},
		{
			name:           "list role command",
			args:           []string{"list", "role", "--help"},
			expectedOutput: "list role called\n",
		},
		{
			name:           "list user command",
			args:           []string{"list", "user", "--help"},
			expectedOutput: "list user called\n",
		},
		{
			name:           "list integration command",
			args:           []string{"list", "integration", "--help"},
			expectedOutput: "list integration called\n",
		},
	}
