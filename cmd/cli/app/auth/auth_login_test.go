...
func TestGetLoginServiceClient(t *testing.T) {
	...
	if creds.AccessTokenExpiresIn != 3600 || creds.RefreshTokenExpiresIn != 7200 {
		t.Fatalf("Expected 3601 and 7200, got %d and %d", creds.AccessTokenExpiresIn, creds.RefreshTokenExpiresIn)
	}
}
