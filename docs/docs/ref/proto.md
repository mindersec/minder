...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| path | <TypeLink type="string">string</TypeLink> |  | Path where the dependency extractor will look for dependency data |
| ecosystems | <TypeLink type="string">string</TypeLink> | repeated | List of ecosystems to check, defaults all supported by the extractor |
