...
| description | <TypeLink type="string">string</TypeLink> |  | description is a short summary of the provider class. |
...
| creation_help | <TypeLink type="string">string</TypeLink> |  | creation_help is high-level guidance for enrolling this provider class. |
