...
| review_event | <TypeLink type="string">string</TypeLink> | optional | review_event is the event to use for the PR review (COMMENT or REQUEST_CHANGES). Default is COMMENT. |
