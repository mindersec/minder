...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| type | <TypeLink type="string">string</TypeLink> |  | type is the type of the alert. * 'security_advisory' can only be used with the 'repository' entity type. * 'pull_request_comment' and 'commit_status' can only be used with the 'pull_request' entity type. |
...
| commit_status | <TypeLink type="minder-v1-RuleType-Definition-Alert-AlertTypeCommitStatus">RuleType.Definition.Alert.AlertTypeCommitStatus</TypeLink> | optional |  |



<Message id="minder-v1-RuleType-Definition-Alert-AlertTypeCommitStatus">RuleType.Definition.Alert.AlertTypeCommitStatus</Message>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| status_name | <TypeLink type="string">string</TypeLink> |  | status_name is the name of the commit status check. |
| description | <TypeLink type="string">string</TypeLink> |  | description is the description of the commit status check, which can be Go templated. |
| target_url | <TypeLink type="string">string</TypeLink> |  | target_url is the URL to set as the target_url in the commit status. It can be an RFC6570 template. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| type | <TypeLink type="string">string</TypeLink> |  | type is the type of the remediation. * 'rest' can be used with any entity type. * 'gh_branch_protection' can only be used with the 'repository' entity type. * 'pull_request' and 'pull_request_comment' can only be used with the 'pull_request' entity type. |
