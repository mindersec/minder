...
| CreateEntity | [CreateEntityRequest](#minder-v1-CreateEntityRequest) | [CreateEntityResponse](#minder-v1-CreateEntityResponse) | CreateEntity creates a new entity instance |
...
<Message id="minder-v1-CreateEntityRequest">CreateEntityRequest</Message>

CreateEntityRequest is the request message for the CreateEntity method


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| context | <TypeLink type="minder-v1-Context">Context</TypeLink> |  | context is the context in which the entity is created |
| name | <TypeLink type="string">string</TypeLink> |  | name is the name of the entity to create |
...
<Message id="minder-v1-CreateEntityResponse">CreateEntityResponse</Message>

CreateEntityResponse is the response message for the CreateEntity method
...
| context | <TypeLink type="minder-v1-Context">Context</TypeLink> |  | context is the context in which the entity is evaluated |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| context | <TypeLink type="minder-v1-Context">Context</TypeLink> |  | context is the context in which the entities are listed |
