...
| identifying_properties | <TypeLink type="google-protobuf-Struct">google.protobuf.Struct</TypeLink> |  | identifying_properties is a map of the minimal set of properties the provider needs in order to uniquely identify an entity. In most cases, upstream_id will suffice, but this is really provider-dependent. |
