...
build-minder-server: ## build minder-server
	...
	@CGO_ENABLED=0 go build -trimpath -tags '$(BUILDTAGS)' -ldflags "-X github.com/mindersec/minder/internal/constants.CLIVersion=$(shell git describe --abbrev=0 --tags)+ref.$(shell git rev-parse --short HEAD)" -o ./bin/$(projectname)-server ./cmd/server
