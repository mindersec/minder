...
type RuleTypeState int32

const (
	RuleTypeState_RULE_TYPE_STATE_UNSPECIFIED RuleTypeState = 0
	RuleTypeState_RULE_TYPE_STATE_ALPHA       RuleTypeState = 1
	RuleTypeState_RULE_TYPE_STATE_BETA        RuleTypeState = 2
	RuleTypeState_RULE_TYPE_STATE_GA          RuleTypeState = 3
	RuleTypeState_RULE_TYPE_STATE_DEPRECATED  RuleTypeState = 4
)

// Enum value maps for RuleTypeState.
var (
	RuleTypeState_name = map[int32]string{
		0: "RULE_TYPE_STATE_UNSPECIFIED",
		1: "RULE_TYPE_STATE_ALPHA",
		2: "RULE_TYPE_STATE_BETA",
		3: "RULE_TYPE_STATE_GA",
		4: "RULE_TYPE_STATE_DEPRECATED",
	}
	RuleTypeState_value = map[string]int32{
...
func (x RuleTypeState) Enum() *RuleTypeState {
	p := new(RuleTypeState)
	*p = x
	return p
}

func (x RuleTypeState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RuleTypeState) Descriptor() protoreflect.EnumDescriptor {
	return file_minder_v1_minder_proto_enumTypes[4].Descriptor()
}

func (RuleTypeState) Type() protoreflect.EnumType {
	return &file_minder_v1_minder_proto_enumTypes[4]
}

func (x RuleTypeState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RuleTypeState.Descriptor instead.
func (RuleTypeState) EnumDescriptor() ([]byte, []int) {
...
type RuleType struct {
	...
	// state is the release state of the rule type, i.e. alpha, beta, ga, deprecated.
	State RuleTypeState `protobuf:"varint,9,opt,name=state,proto3,enum=minder.v1.RuleTypeState" json:"state,omitempty"`
}
...
func (x *RuleType) GetState() RuleTypeState {
	if x != nil {
		return x.State
	}
	return RuleTypeState_RULE_TYPE_STATE_UNSPECIFIED
}
...
var file_minder_v1_minder_proto_rawDesc = []byte{
	...
	0xc8, 0x18, 0x0a, 0x08, 0x52, 0x75, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x13, 0x0a, 0x02,
	...
	0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x12, 0x2e, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65,
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x6d, 0x69, 0x6e, 0x64, 0x65, 0x72, 0x2e,
	0x76, 0x31, 0x2e, 0x52, 0x75, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x1a, 0xe9, 0x15, 0x0a, 0x0a, 0x44, 0x65, 0x66, 0x69,
	...
	,
	...
	0x32, 0xc5, 0x0f, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x76,
...
var file_minder_v1_minder_proto_goTypes = []any{
	...
	(RuleTypeState)(0),                                 // 4: minder.v1.RuleTypeState
...
var file_minder_v1_minder_proto_depIdxs = []int32{
	...
	4,   // 106: minder.v1.RuleType.state:type_name -> minder.v1.RuleTypeState
