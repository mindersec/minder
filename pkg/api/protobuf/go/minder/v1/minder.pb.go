...
var file_minder_v1_minder_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x1c, 0xaa, 0xf8, 0x18, 0x04, 0x18, 0x01, 0x28, 0x01, 0x82, 0xd3, 0xe4, 0x93,
	...
	0x12, 0x0c, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x32, 0x9e,
...
var file_minder_v1_minder_proto_depIdxs = []int32{
	...
	61,  // 126: minder.v1.UserService.CreateUser:input_type -> minder.v1.CreateUserRequest
	63,  // 127: minder.v1.UserService.DeleteUser:input_type -> minder.v1.DeleteUserRequest
	66,  // 128: minder.v1.UserService.GetUser:input_type -> minder.v1.GetUserRequest
	68,  // 129: minder.v1.ProfileService.CreateProfile:input_type -> minder.v1.CreateProfileRequest
	70,  // 130: minder.v1.ProfileService.UpdateProfile:input_type -> minder.v1.UpdateProfileRequest
	72,  // 131: minder.v1.ProfileService.DeleteProfile:input_type -> minder.v1.DeleteProfileRequest
	74,  // 132: minder.v1.ProfileService.ListProfiles:input_type -> minder.v1.ListProfilesRequest
	76,  // 133: minder.v1.ProfileService.GetProfileById:input_type -> minder.v1.GetProfileByIdRequest
	80,  // 134: minder.v1.ProfileService.GetProfileStatusByName:input_type -> minder.v1.GetProfileStatusByNameRequest
	82,  // 135: minder.v1.ProfileService.GetProfileStatusByProject:input_type -> minder.v1.GetProfileStatusByProjectRequest
	92,  // 136: minder.v1.ProfileService.ListRuleTypes:input_type -> minder.v1.ListRuleTypesRequest
	94,  // 137: minder.v1.ProfileService.GetRuleTypeByName:input_type -> minder.v1.GetRuleTypeByNameRequest
	96,  // 138: minder.v1.ProfileService.GetRuleTypeById:input_type -> minder.v1.GetRuleTypeByIdRequest
	98,  // 139: minder.v1.ProfileService.CreateRuleType:input_type -> minder.v1.CreateRuleTypeRequest
	100, // 140: minder.v1.ProfileService.UpdateRuleType:input_type -> minder.v1.UpdateRuleTypeRequest
	102, // 141: minder.v1.ProfileService.DeleteRuleType:input_type -> minder.v1.DeleteRuleTypeRequest
	84,  // 142: minder.v1.KeyService.GetPublicKey:input_type -> minder.v1.GetPublicKeyRequest
	86,  // 143: minder.v1.KeyService.CreateKeyPair:input_type -> minder.v1.CreateKeyPairRequest
	16,  // 144: minder.v1.HealthService.CheckHealth:output_type -> minder.v1.CheckHealthResponse
	5,   // 145: minder.v1.ArtifactService.ListArtifacts:output_type -> minder.v1.ListArtifactsResponse
	11,  // 146: minder.v1.ArtifactService.GetArtifactById:output_type -> minder.v1.GetArtifactByIdResponse
	18,  // 147: minder.v1.OAuthService.GetAuthorizationURL:output_type -> minder.v1.GetAuthorizationURLResponse
	138, // 148: minder.v1.OAuthService.ExchangeCodeForTokenCLI:output_type -> google.api.HttpBody
	23,  // 149: minder.v1.OAuthService.ExchangeCodeForTokenWEB:output_type -> minder.v1.ExchangeCodeForTokenWEBResponse
	21,  // 150: minder.v1.OAuthService.StoreProviderToken:output_type -> minder.v1.StoreProviderTokenResponse
	25,  // 151: minder.v1.OAuthService.RevokeOauthTokens:output_type -> minder.v1.RevokeOauthTokensResponse
	27,  // 152: minder.v1.OAuthService.RevokeOauthProjectToken:output_type -> minder.v1.RevokeOauthProjectTokenResponse
	49,  // 153: minder.v1.OAuthService.VerifyProviderTokenFrom:output_type -> minder.v1.VerifyProviderTokenFromResponse
	37,  // 154: minder.v1.RepositoryService.RegisterRepository:output_type -> minder.v1.RegisterRepositoryResponse
	32,  // 155: minder.v1.RepositoryService.ListRemoteRepositoriesFromProvider:output_type -> minder.v1.ListRemoteRepositoriesFromProviderResponse
	47,  // 156: minder.v1.RepositoryService.ListRepositories:output_type -> minder.v1.ListRepositoriesResponse
	39,  // 157: minder.v1.RepositoryService.GetRepositoryById:output_type -> minder.v1.GetRepositoryByIdResponse
	43,  // 158: minder.v1.RepositoryService.GetRepositoryByName:output_type -> minder.v1.GetRepositoryByNameResponse
	41,  // 159: minder.v1.RepositoryService.DeleteRepositoryById:output_type -> minder.v1.DeleteRepositoryByIdResponse
	45,  // 160: minder.v1.RepositoryService.DeleteRepositoryByName:output_type -> minder.v1.DeleteRepositoryByNameResponse
	62,  // 161: minder.v1.UserService.CreateUser:output_type -> minder.v1.CreateUserResponse
	64,  // 162: minder.v1.UserService.DeleteUser:output_type -> minder.v1.DeleteUserResponse
	67,  // 163: minder.v1.UserService.GetUser:output_type -> minder.v1.GetUserResponse
	69,  // 164: minder.v1.ProfileService.CreateProfile:output_type -> minder.v1.CreateProfileResponse
	71,  // 165: minder.v1.ProfileService.UpdateProfile:output_type -> minder.v1.UpdateProfileResponse
	73,  // 166: minder.v1.ProfileService.DeleteProfile:output_type -> minder.v1.DeleteProfileResponse
	75,  // 167: minder.v1.ProfileService.ListProfiles:output_type -> minder.v1.ListProfilesResponse
	77,  // 168: minder.v1.ProfileService.GetProfileById:output_type -> minder.v1.GetProfileByIdResponse
	81,  // 169: minder.v1.ProfileService.GetProfileStatusByName:output_type -> minder.v1.GetProfileStatusByNameResponse
	83,  // 170: minder.v1.ProfileService.GetProfileStatusByProject:output_type -> minder.v1.GetProfileStatusByProjectResponse
	93,  // 171: minder.v1.ProfileService.ListRuleTypes:output_type -> minder.v1.ListRuleTypesResponse
	95,  // 172: minder.v1.ProfileService.GetRuleTypeByName:output_type -> minder.v1.GetRuleTypeByNameResponse
	97,  // 173: minder.v1.ProfileService.GetRuleTypeById:output_type -> minder.v1.GetRuleTypeByIdResponse
	99,  // 174: minder.v1.ProfileService.CreateRuleType:output_type -> minder.v1.CreateRuleTypeResponse
	101, // 175: minder.v1.ProfileService.UpdateRuleType:output_type -> minder.v1.UpdateRuleTypeResponse
	103, // 176: minder.v1.ProfileService.DeleteRuleType:output_type -> minder.v1.DeleteRuleTypeResponse
	85,  // 177: minder.v1.KeyService.GetPublicKey:output_type -> minder.v1.GetPublicKeyResponse
	87,  // 178: minder.v1.KeyService.CreateKeyPair:output_type -> minder.v1.CreateKeyPairResponse
