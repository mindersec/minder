...
func file_minder_v1_minder_proto_rawDescGZIP() []byte {
	file_minder_v1_minder_proto_rawDescOnce.Do(func() {
		file_minder_v1_minder_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_minder_v1_minder_proto_rawDescData)))
	})
	return []byte(file_minder_v1_minder_proto_rawDescData)
}
