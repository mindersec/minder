...
var file_minder_v1_minder_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x2a, 0x62, 0x0a, 0x0b, 0x4f, 0x62, 0x6a, 0x65, 0x63,
	...
	0x42, 0x55, 0x49, 0x4c, 0x44, 0x10, 0x08, 0x2a, 0x97, 0x02, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x76,
...
var file_minder_v1_minder_proto_depIdxs = []int32{
	...
	115, // 182: minder.v1.EvaluationHistoryRule.severity:type_name -> minder.v1.Severity
	86,  // 183: minder.v1.AutoRegistration.EntitiesEntry.value:type_name -> minder.v1.EntityAutoRegistrationConfig
	78,  // 184: minder.v1.ListEvaluationResultsResponse.EntityProfileEvaluationResults.profile_status:type_name -> minder.v1.ProfileStatus
	80,  // 185: minder.v1.ListEvaluationResultsResponse.EntityProfileEvaluationResults.results:type_name -> minder.v1.RuleEvaluationStatus
	81,  // 186: minder.v1.ListEvaluationResultsResponse.EntityEvaluationResults.entity:type_name -> minder.v1.EntityTypedId
	181, // 187: minder.v1.ListEvaluationResultsResponse.EntityEvaluationResults.profiles:type_name -> minder.v1.ListEvaluationResultsResponse.EntityProfileEvaluationResults
	204, // 188: minder.v1.RuleType.Definition.rule_schema:type_name -> google.protobuf.Struct
	204, // 189: minder.v1.RuleType.Definition.param_schema:type_name -> google.protobuf.Struct
	186, // 190: minder.v1.RuleType.Definition.ingest:type_name -> minder.v1.RuleType.Definition.Ingest
	187, // 191: minder.v1.RuleType.Definition.eval:type_name -> minder.v1.RuleType.Definition.Eval
	188, // 192: minder.v1.RuleType.Definition.remediate:type_name -> minder.v1.RuleType.Definition.Remediate
	189, // 193: minder.v1.RuleType.Definition.alert:type_name -> minder.v1.RuleType.Definition.Alert
	110, // 194: minder.v1.RuleType.Definition.Ingest.rest:type_name -> minder.v1.RestType
	111, // 195: minder.v1.RuleType.Definition.Ingest.builtin:type_name -> minder.v1.BuiltinType
	112, // 196: minder.v1.RuleType.Definition.Ingest.artifact:type_name -> minder.v1.ArtifactType
	113, // 197: minder.v1.RuleType.Definition.Ingest.git:type_name -> minder.v1.GitType
	114, // 198: minder.v1.RuleType.Definition.Ingest.diff:type_name -> minder.v1.DiffType
	190, // 199: minder.v1.RuleType.Definition.Eval.jq:type_name -> minder.v1.RuleType.Definition.Eval.JQComparison
	191, // 200: minder.v1.RuleType.Definition.Eval.rego:type_name -> minder.v1.RuleType.Definition.Eval.Rego
	192, // 201: minder.v1.RuleType.Definition.Eval.vulncheck:type_name -> minder.v1.RuleType.Definition.Eval.Vulncheck
	193, // 202: minder.v1.RuleType.Definition.Eval.trusty:type_name -> minder.v1.RuleType.Definition.Eval.Trusty
	194, // 203: minder.v1.RuleType.Definition.Eval.homoglyphs:type_name -> minder.v1.RuleType.Definition.Eval.Homoglyphs
	110, // 204: minder.v1.RuleType.Definition.Remediate.rest:type_name -> minder.v1.RestType
	196, // 205: minder.v1.RuleType.Definition.Remediate.gh_branch_protection:type_name -> minder.v1.RuleType.Definition.Remediate.GhBranchProtectionType
	197, // 206: minder.v1.RuleType.Definition.Remediate.pull_request:type_name -> minder.v1.RuleType.Definition.Remediate.PullRequestRemediation
	200, // 207: minder.v1.RuleType.Definition.Alert.security_advisory:type_name -> minder.v1.RuleType.Definition.Alert.AlertTypeSA
	195, // 208: minder.v1.RuleType.Definition.Eval.JQComparison.ingested:type_name -> minder.v1.RuleType.Definition.Eval.JQComparison.Operator
	195, // 209: minder.v1.RuleType.Definition.Eval.JQComparison.profile:type_name -> minder.v1.RuleType.Definition.Eval.JQComparison.Operator
	198, // 210: minder.v1.RuleType.Definition.Remediate.PullRequestRemediation.contents:type_name -> minder.v1.RuleType.Definition.Remediate.PullRequestRemediation.Content
	199, // 211: minder.v1.RuleType.Definition.Remediate.PullRequestRemediation.actions_replace_tags_with_sha:type_name -> minder.v1.RuleType.Definition.Remediate.PullRequestRemediation.ActionsReplaceTagsWithSha
	204, // 212: minder.v1.Profile.Rule.params:type_name -> google.protobuf.Struct
	204, // 213: minder.v1.Profile.Rule.def:type_name -> google.protobuf.Struct
	206, // 214: minder.v1.name:extendee -> google.protobuf.EnumValueOptions
	207, // 215: minder.v1.rpc_options:extendee -> google.protobuf.MethodOptions
	9,   // 216: minder.v1.rpc_options:type_name -> minder.v1.RpcOptions
	27,  // 217: minder.v1.HealthService.CheckHealth:input_type -> minder.v1.CheckHealthRequest
	12,  // 218: minder.v1.ArtifactService.ListArtifacts:input_type -> minder.v1.ListArtifactsRequest
	16,  // 219: minder.v1.ArtifactService.GetArtifactById:input_type -> minder.v1.GetArtifactByIdRequest
	18,  // 220: minder.v1.ArtifactService.GetArtifactByName:input_type -> minder.v1.GetArtifactByNameRequest
	29,  // 221: minder.v1.OAuthService.GetAuthorizationURL:input_type -> minder.v1.GetAuthorizationURLRequest
	31,  // 222: minder.v1.OAuthService.StoreProviderToken:input_type -> minder.v1.StoreProviderTokenRequest
	53,  // 223: minder.v1.OAuthService.VerifyProviderTokenFrom:input_type -> minder.v1.VerifyProviderTokenFromRequest
	55,  // 224: minder.v1.OAuthService.VerifyProviderCredential:input_type -> minder.v1.VerifyProviderCredentialRequest
	38,  // 225: minder.v1.RepositoryService.RegisterRepository:input_type -> minder.v1.RegisterRepositoryRequest
	34,  // 226: minder.v1.RepositoryService.ListRemoteRepositoriesFromProvider:input_type -> minder.v1.ListRemoteRepositoriesFromProviderRequest
	49,  // 227: minder.v1.RepositoryService.ListRepositories:input_type -> minder.v1.ListRepositoriesRequest
	41,  // 228: minder.v1.RepositoryService.GetRepositoryById:input_type -> minder.v1.GetRepositoryByIdRequest
	45,  // 229: minder.v1.RepositoryService.GetRepositoryByName:input_type -> minder.v1.GetRepositoryByNameRequest
	43,  // 230: minder.v1.RepositoryService.DeleteRepositoryById:input_type -> minder.v1.DeleteRepositoryByIdRequest
	47,  // 231: minder.v1.RepositoryService.DeleteRepositoryByName:input_type -> minder.v1.DeleteRepositoryByNameRequest
	58,  // 232: minder.v1.UserService.CreateUser:input_type -> minder.v1.CreateUserRequest
	60,  // 233: minder.v1.UserService.DeleteUser:input_type -> minder.v1.DeleteUserRequest
	64,  // 234: minder.v1.UserService.GetUser:input_type -> minder.v1.GetUserRequest
	145, // 235: minder.v1.UserService.ListInvitations:input_type -> minder.v1.ListInvitationsRequest
	147, // 236: minder.v1.UserService.ResolveInvitation:input_type -> minder.v1.ResolveInvitationRequest
	66,  // 237: minder.v1.ProfileService.CreateProfile:input_type -> minder.v1.CreateProfileRequest
	68,  // 238: minder.v1.ProfileService.UpdateProfile:input_type -> minder.v1.UpdateProfileRequest
	70,  // 239: minder.v1.ProfileService.PatchProfile:input_type -> minder.v1.PatchProfileRequest
	72,  // 240: minder.v1.ProfileService.DeleteProfile:input_type -> minder.v1.DeleteProfileRequest
	74,  // 241: minder.v1.ProfileService.ListProfiles:input_type -> minder.v1.ListProfilesRequest
	76,  // 242: minder.v1.ProfileService.GetProfileById:input_type -> minder.v1.GetProfileByIdRequest
	82,  // 243: minder.v1.ProfileService.GetProfileStatusByName:input_type -> minder.v1.GetProfileStatusByNameRequest
	84,  // 244: minder.v1.ProfileService.GetProfileStatusByProject:input_type -> minder.v1.GetProfileStatusByProjectRequest
	96,  // 245: minder.v1.ProfileService.ListRuleTypes:input_type -> minder.v1.ListRuleTypesRequest
	98,  // 246: minder.v1.ProfileService.GetRuleTypeByName:input_type -> minder.v1.GetRuleTypeByNameRequest
	100, // 247: minder.v1.ProfileService.GetRuleTypeById:input_type -> minder.v1.GetRuleTypeByIdRequest
	102, // 248: minder.v1.ProfileService.CreateRuleType:input_type -> minder.v1.CreateRuleTypeRequest
	104, // 249: minder.v1.ProfileService.UpdateRuleType:input_type -> minder.v1.UpdateRuleTypeRequest
	106, // 250: minder.v1.ProfileService.DeleteRuleType:input_type -> minder.v1.DeleteRuleTypeRequest
	108, // 251: minder.v1.EvalResultsService.ListEvaluationResults:input_type -> minder.v1.ListEvaluationResultsRequest
	170, // 252: minder.v1.EvalResultsService.ListEvaluationHistory:input_type -> minder.v1.ListEvaluationHistoryRequest
	133, // 253: minder.v1.PermissionsService.ListRoles:input_type -> minder.v1.ListRolesRequest
	135, // 254: minder.v1.PermissionsService.ListRoleAssignments:input_type -> minder.v1.ListRoleAssignmentsRequest
	137, // 255: minder.v1.PermissionsService.AssignRole:input_type -> minder.v1.AssignRoleRequest
	139, // 256: minder.v1.PermissionsService.UpdateRole:input_type -> minder.v1.UpdateRoleRequest
	141, // 257: minder.v1.PermissionsService.RemoveRole:input_type -> minder.v1.RemoveRoleRequest
	118, // 258: minder.v1.ProjectsService.ListProjects:input_type -> minder.v1.ListProjectsRequest
	120, // 259: minder.v1.ProjectsService.CreateProject:input_type -> minder.v1.CreateProjectRequest
	129, // 260: minder.v1.ProjectsService.ListChildProjects:input_type -> minder.v1.ListChildProjectsRequest
	122, // 261: minder.v1.ProjectsService.DeleteProject:input_type -> minder.v1.DeleteProjectRequest
	124, // 262: minder.v1.ProjectsService.UpdateProject:input_type -> minder.v1.UpdateProjectRequest
	127, // 263: minder.v1.ProjectsService.PatchProject:input_type -> minder.v1.PatchProjectRequest
	131, // 264: minder.v1.ProjectsService.CreateEntityReconciliationTask:input_type -> minder.v1.CreateEntityReconciliationTaskRequest
	164, // 265: minder.v1.ProvidersService.PatchProvider:input_type -> minder.v1.PatchProviderRequest
	150, // 266: minder.v1.ProvidersService.GetProvider:input_type -> minder.v1.GetProviderRequest
	152, // 267: minder.v1.ProvidersService.ListProviders:input_type -> minder.v1.ListProvidersRequest
	154, // 268: minder.v1.ProvidersService.CreateProvider:input_type -> minder.v1.CreateProviderRequest
	156, // 269: minder.v1.ProvidersService.DeleteProvider:input_type -> minder.v1.DeleteProviderRequest
	158, // 270: minder.v1.ProvidersService.DeleteProviderByID:input_type -> minder.v1.DeleteProviderByIDRequest
	160, // 271: minder.v1.ProvidersService.GetUnclaimedProviders:input_type -> minder.v1.GetUnclaimedProvidersRequest
	162, // 272: minder.v1.ProvidersService.ListProviderClasses:input_type -> minder.v1.ListProviderClassesRequest
	51,  // 273: minder.v1.ProvidersService.ReconcileEntityRegistration:input_type -> minder.v1.ReconcileEntityRegistrationRequest
	25,  // 274: minder.v1.InviteService.GetInviteDetails:input_type -> minder.v1.GetInviteDetailsRequest
	28,  // 275: minder.v1.HealthService.CheckHealth:output_type -> minder.v1.CheckHealthResponse
	13,  // 276: minder.v1.ArtifactService.ListArtifacts:output_type -> minder.v1.ListArtifactsResponse
	17,  // 277: minder.v1.ArtifactService.GetArtifactById:output_type -> minder.v1.GetArtifactByIdResponse
	19,  // 278: minder.v1.ArtifactService.GetArtifactByName:output_type -> minder.v1.GetArtifactByNameResponse
	30,  // 279: minder.v1.OAuthService.GetAuthorizationURL:output_type -> minder.v1.GetAuthorizationURLResponse
	32,  // 280: minder.v1.OAuthService.StoreProviderToken:output_type -> minder.v1.StoreProviderTokenResponse
	54,  // 281: minder.v1.OAuthService.VerifyProviderTokenFrom:output_type -> minder.v1.VerifyProviderTokenFromResponse
	56,  // 282: minder.v1.OAuthService.VerifyProviderCredential:output_type -> minder.v1.VerifyProviderCredentialResponse
	40,  // 283: minder.v1.RepositoryService.RegisterRepository:output_type -> minder.v1.RegisterRepositoryResponse
	35,  // 284: minder.v1.RepositoryService.ListRemoteRepositoriesFromProvider:output_type -> minder.v1.ListRemoteRepositoriesFromProviderResponse
	50,  // 285: minder.v1.RepositoryService.ListRepositories:output_type -> minder.v1.ListRepositoriesResponse
	42,  // 286: minder.v1.RepositoryService.GetRepositoryById:output_type -> minder.v1.GetRepositoryByIdResponse
	46,  // 287: minder.v1.RepositoryService.GetRepositoryByName:output_type -> minder.v1.GetRepositoryByNameResponse
	44,  // 288: minder.v1.RepositoryService.DeleteRepositoryById:output_type -> minder.v1.DeleteRepositoryByIdResponse
	48,  // 289: minder.v1.RepositoryService.DeleteRepositoryByName:output_type -> minder.v1.DeleteRepositoryByNameResponse
	59,  // 290: minder.v1.UserService.CreateUser:output_type -> minder.v1.CreateUserResponse
	61,  // 291: minder.v1.UserService.DeleteUser:output_type -> minder.v1.DeleteUserResponse
	65,  // 292: minder.v1.UserService.GetUser:output_type -> minder.v1.GetUserResponse
	146, // 293: minder.v1.UserService.ListInvitations:output_type -> minder.v1.ListInvitationsResponse
	148, // 294: minder.v1.UserService.ResolveInvitation:output_type -> minder.v1.ResolveInvitationResponse
	67,  // 295: minder.v1.ProfileService.CreateProfile:output_type -> minder.v1.CreateProfileResponse
	69,  // 296: minder.v1.ProfileService.UpdateProfile:output_type -> minder.v1.UpdateProfileResponse
	71,  // 297: minder.v1.ProfileService.PatchProfile:output_type -> minder.v1.PatchProfileResponse
	73,  // 298: minder.v1.ProfileService.DeleteProfile:output_type -> minder.v1.DeleteProfileResponse
	75,  // 299: minder.v1.ProfileService.ListProfiles:output_type -> minder.v1.ListProfilesResponse
	77,  // 300: minder.v1.ProfileService.GetProfileById:output_type -> minder.v1.GetProfileByIdResponse
	83,  // 301: minder.v1.ProfileService.GetProfileStatusByName:output_type -> minder.v1.GetProfileStatusByNameResponse
	85,  // 302: minder.v1.ProfileService.GetProfileStatusByProject:output_type -> minder.v1.GetProfileStatusByProjectResponse
	97,  // 303: minder.v1.ProfileService.ListRuleTypes:output_type -> minder.v1.ListRuleTypesResponse
	99,  // 304: minder.v1.ProfileService.GetRuleTypeByName:output_type -> minder.v1.GetRuleTypeByNameResponse
	101, // 305: minder.v1.ProfileService.GetRuleTypeById:output_type -> minder.v1.GetRuleTypeByIdResponse
	103, // 306: minder.v1.ProfileService.CreateRuleType:output_type -> minder.v1.CreateRuleTypeResponse
	105, // 307: minder.v1.ProfileService.UpdateRuleType:output_type -> minder.v1.UpdateRuleTypeResponse
	107, // 308: minder.v1.ProfileService.DeleteRuleType:output_type -> minder.v1.DeleteRuleTypeResponse
	109, // 309: minder.v1.EvalResultsService.ListEvaluationResults:output_type -> minder.v1.ListEvaluationResultsResponse
	171, // 310: minder.v1.EvalResultsService.ListEvaluationHistory:output_type -> minder.v1.ListEvaluationHistoryResponse
	134, // 311: minder.v1.PermissionsService.ListRoles:output_type -> minder.v1.ListRolesResponse
	136, // 312: minder.v1.PermissionsService.ListRoleAssignments:output_type -> minder.v1.ListRoleAssignmentsResponse
	138, // 313: minder.v1.PermissionsService.AssignRole:output_type -> minder.v1.AssignRoleResponse
	140, // 314: minder.v1.PermissionsService.UpdateRole:output_type -> minder.v1.UpdateRoleResponse
	142, // 315: minder.v1.PermissionsService.RemoveRole:output_type -> minder.v1.RemoveRoleResponse
	119, // 316: minder.v1.ProjectsService.ListProjects:output_type -> minder.v1.ListProjectsResponse
	121, // 317: minder.v1.ProjectsService.CreateProject:output_type -> minder.v1.CreateProjectResponse
	130, // 318: minder.v1.ProjectsService.ListChildProjects:output_type -> minder.v1.ListChildProjectsResponse
	123, // 319: minder.v1.ProjectsService.DeleteProject:output_type -> minder.v1.DeleteProjectResponse
	125, // 320: minder.v1.ProjectsService.UpdateProject:output_type -> minder.v1.UpdateProjectResponse
	128, // 321: minder.v1.ProjectsService.PatchProject:output_type -> minder.v1.PatchProjectResponse
	132, // 322: minder.v1.ProjectsService.CreateEntityReconciliationTask:output_type -> minder.v1.CreateEntityReconciliationTaskResponse
	165, // 323: minder.v1.ProvidersService.PatchProvider:output_type -> minder.v1.PatchProviderResponse
	151, // 324: minder.v1.ProvidersService.GetProvider:output_type -> minder.v1.GetProviderResponse
	153, // 325: minder.v1.ProvidersService.ListProviders:output_type -> minder.v1.ListProvidersResponse
	155, // 326: minder.v1.ProvidersService.CreateProvider:output_type -> minder.v1.CreateProviderResponse
	157, // 327: minder.v1.ProvidersService.DeleteProvider:output_type -> minder.v1.DeleteProviderResponse
	159, // 328: minder.v1.ProvidersService.DeleteProviderByID:output_type -> minder.v1.DeleteProviderByIDResponse
	161, // 329: minder.v1.ProvidersService.GetUnclaimedProviders:output_type -> minder.v1.GetUnclaimedProvidersResponse
	163, // 330: minder.v1.ProvidersService.ListProviderClasses:output_type -> minder.v1.ListProviderClassesResponse
	52,  // 331: minder.v1.ProvidersService.ReconcileEntityRegistration:output_type -> minder.v1.ReconcileEntityRegistrationResponse
	26,  // 332: minder.v1.InviteService.GetInviteDetails:output_type -> minder.v1.GetInviteDetailsResponse
	...
	214, // [214:216] is the sub-list for extension extendee
