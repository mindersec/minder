...
var file_mediator_v1_mediator_proto_rawDesc = []byte{
	...
	0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x13, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55,
	0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xf6, 0x02, 0x0a, 0x12, 0x43,
	...
	0x69, 0x6c, 0x88, 0x01, 0x01, 0x12, 0x29, 0x0a, 0x10, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74,
	0x79, 0x5f, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x61, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x39, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x61, 0x6d, 0x65, 0x22, 0x48, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x42, 0x11, 0x0a, 0x0f, 0x65, 0x6e, 0x74, 0x69,
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x4d, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x52, 0x75, 0x6c,
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x7d, 0x32, 0xd0, 0x04, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x61, 0x0a, 0x06, 0x4c, 0x6f, 0x67, 0x4f, 0x75,
	...
	0x75, 0x74, 0x68, 0x2f, 0x76, 0x65, 0x72, 0x69, 0x66, 0x79, 0x32, 0xc2, 0x06, 0x0a, 0x11, 0x52,
...
var file_mediator_v1_mediator_proto_depIdxs = []int32{
	...
	38,  // 159: mediator.v1.RepositoryService.SyncRepositories:input_type -> mediator.v1.SyncRepositoriesRequest
	40,  // 160: mediator.v1.RepositoryService.RegisterRepository:input_type -> mediator.v1.RegisterRepositoryRequest
	49,  // 161: mediator.v1.RepositoryService.ListRepositories:input_type -> mediator.v1.ListRepositoriesRequest
	45,  // 162: mediator.v1.RepositoryService.GetRepositoryById:input_type -> mediator.v1.GetRepositoryByIdRequest
	47,  // 163: mediator.v1.RepositoryService.GetRepositoryByName:input_type -> mediator.v1.GetRepositoryByNameRequest
	63,  // 164: mediator.v1.BranchProtectionService.GetBranchProtection:input_type -> mediator.v1.GetBranchProtectionRequest
	66,  // 165: mediator.v1.OrganizationService.CreateOrganization:input_type -> mediator.v1.CreateOrganizationRequest
	71,  // 166: mediator.v1.OrganizationService.GetOrganizations:input_type -> mediator.v1.GetOrganizationsRequest
	73,  // 167: mediator.v1.OrganizationService.GetOrganization:input_type -> mediator.v1.GetOrganizationRequest
	75,  // 168: mediator.v1.OrganizationService.GetOrganizationByName:input_type -> mediator.v1.GetOrganizationByNameRequest
	69,  // 169: mediator.v1.OrganizationService.DeleteOrganization:input_type -> mediator.v1.DeleteOrganizationRequest
	77,  // 170: mediator.v1.GroupService.CreateGroup:input_type -> mediator.v1.CreateGroupRequest
	80,  // 171: mediator.v1.GroupService.GetGroups:input_type -> mediator.v1.GetGroupsRequest
	78,  // 172: mediator.v1.GroupService.GetGroupByName:input_type -> mediator.v1.GetGroupByNameRequest
	79,  // 173: mediator.v1.GroupService.GetGroupById:input_type -> mediator.v1.GetGroupByIdRequest
	86,  // 174: mediator.v1.GroupService.DeleteGroup:input_type -> mediator.v1.DeleteGroupRequest
	88,  // 175: mediator.v1.RoleService.CreateRoleByOrganization:input_type -> mediator.v1.CreateRoleByOrganizationRequest
	90,  // 176: mediator.v1.RoleService.CreateRoleByGroup:input_type -> mediator.v1.CreateRoleByGroupRequest
	92,  // 177: mediator.v1.RoleService.DeleteRole:input_type -> mediator.v1.DeleteRoleRequest
	95,  // 178: mediator.v1.RoleService.GetRoles:input_type -> mediator.v1.GetRolesRequest
	97,  // 179: mediator.v1.RoleService.GetRolesByGroup:input_type -> mediator.v1.GetRolesByGroupRequest
	99,  // 180: mediator.v1.RoleService.GetRoleById:input_type -> mediator.v1.GetRoleByIdRequest
	101, // 181: mediator.v1.RoleService.GetRoleByName:input_type -> mediator.v1.GetRoleByNameRequest
	103, // 182: mediator.v1.UserService.CreateUser:input_type -> mediator.v1.CreateUserRequest
	105, // 183: mediator.v1.UserService.DeleteUser:input_type -> mediator.v1.DeleteUserRequest
	108, // 184: mediator.v1.UserService.GetUsers:input_type -> mediator.v1.GetUsersRequest
	110, // 185: mediator.v1.UserService.GetUsersByOrganization:input_type -> mediator.v1.GetUsersByOrganizationRequest
	112, // 186: mediator.v1.UserService.GetUsersByGroup:input_type -> mediator.v1.GetUsersByGroupRequest
	114, // 187: mediator.v1.UserService.GetUserById:input_type -> mediator.v1.GetUserByIdRequest
	116, // 188: mediator.v1.UserService.GetUserBySubject:input_type -> mediator.v1.GetUserBySubjectRequest
	118, // 189: mediator.v1.UserService.GetUser:input_type -> mediator.v1.GetUserRequest
	120, // 190: mediator.v1.PolicyService.CreatePolicy:input_type -> mediator.v1.CreatePolicyRequest
	122, // 191: mediator.v1.PolicyService.DeletePolicy:input_type -> mediator.v1.DeletePolicyRequest
	124, // 192: mediator.v1.PolicyService.ListPolicies:input_type -> mediator.v1.ListPoliciesRequest
	126, // 193: mediator.v1.PolicyService.GetPolicyById:input_type -> mediator.v1.GetPolicyByIdRequest
	130, // 194: mediator.v1.PolicyService.GetPolicyStatusById:input_type -> mediator.v1.GetPolicyStatusByIdRequest
	132, // 195: mediator.v1.PolicyService.GetPolicyStatusByGroup:input_type -> mediator.v1.GetPolicyStatusByGroupRequest
	142, // 196: mediator.v1.PolicyService.ListRuleTypes:input_type -> mediator.v1.ListRuleTypesRequest
	144, // 197: mediator.v1.PolicyService.GetRuleTypeByName:input_type -> mediator.v1.GetRuleTypeByNameRequest
	146, // 198: mediator.v1.PolicyService.GetRuleTypeById:input_type -> mediator.v1.GetRuleTypeByIdRequest
	148, // 199: mediator.v1.PolicyService.CreateRuleType:input_type -> mediator.v1.CreateRuleTypeRequest
	150, // 200: mediator.v1.PolicyService.UpdateRuleType:input_type -> mediator.v1.UpdateRuleTypeRequest
	152, // 201: mediator.v1.PolicyService.DeleteRuleType:input_type -> mediator.v1.DeleteRuleTypeRequest
	134, // 202: mediator.v1.KeyService.GetPublicKey:input_type -> mediator.v1.GetPublicKeyRequest
	136, // 203: mediator.v1.KeyService.CreateKeyPair:input_type -> mediator.v1.CreateKeyPairRequest
	18,  // 204: mediator.v1.HealthService.CheckHealth:output_type -> mediator.v1.CheckHealthResponse
	6,   // 205: mediator.v1.ArtifactService.ListArtifacts:output_type -> mediator.v1.ListArtifactsResponse
	13,  // 206: mediator.v1.ArtifactService.GetArtifactById:output_type -> mediator.v1.GetArtifactByIdResponse
	20,  // 207: mediator.v1.OAuthService.GetAuthorizationURL:output_type -> mediator.v1.GetAuthorizationURLResponse
	180, // 208: mediator.v1.OAuthService.ExchangeCodeForTokenCLI:output_type -> google.api.HttpBody
	25,  // 209: mediator.v1.OAuthService.ExchangeCodeForTokenWEB:output_type -> mediator.v1.ExchangeCodeForTokenWEBResponse
	23,  // 210: mediator.v1.OAuthService.StoreProviderToken:output_type -> mediator.v1.StoreProviderTokenResponse
	33,  // 211: mediator.v1.OAuthService.RevokeOauthTokens:output_type -> mediator.v1.RevokeOauthTokensResponse
	35,  // 212: mediator.v1.OAuthService.RevokeOauthGroupToken:output_type -> mediator.v1.RevokeOauthGroupTokenResponse
	54,  // 213: mediator.v1.OAuthService.VerifyProviderTokenFrom:output_type -> mediator.v1.VerifyProviderTokenFromResponse
	27,  // 214: mediator.v1.AuthService.LogOut:output_type -> mediator.v1.LogOutResponse
	29,  // 215: mediator.v1.AuthService.RevokeTokens:output_type -> mediator.v1.RevokeTokensResponse
	31,  // 216: mediator.v1.AuthService.RevokeUserToken:output_type -> mediator.v1.RevokeUserTokenResponse
	37,  // 217: mediator.v1.AuthService.RefreshToken:output_type -> mediator.v1.RefreshTokenResponse
	52,  // 218: mediator.v1.AuthService.Verify:output_type -> mediator.v1.VerifyResponse
	39,  // 219: mediator.v1.RepositoryService.SyncRepositories:output_type -> mediator.v1.SyncRepositoriesResponse
	43,  // 220: mediator.v1.RepositoryService.RegisterRepository:output_type -> mediator.v1.RegisterRepositoryResponse
	50,  // 221: mediator.v1.RepositoryService.ListRepositories:output_type -> mediator.v1.ListRepositoriesResponse
	46,  // 222: mediator.v1.RepositoryService.GetRepositoryById:output_type -> mediator.v1.GetRepositoryByIdResponse
	48,  // 223: mediator.v1.RepositoryService.GetRepositoryByName:output_type -> mediator.v1.GetRepositoryByNameResponse
	65,  // 224: mediator.v1.BranchProtectionService.GetBranchProtection:output_type -> mediator.v1.GetBranchProtectionResponse
	67,  // 225: mediator.v1.OrganizationService.CreateOrganization:output_type -> mediator.v1.CreateOrganizationResponse
	72,  // 226: mediator.v1.OrganizationService.GetOrganizations:output_type -> mediator.v1.GetOrganizationsResponse
	74,  // 227: mediator.v1.OrganizationService.GetOrganization:output_type -> mediator.v1.GetOrganizationResponse
	76,  // 228: mediator.v1.OrganizationService.GetOrganizationByName:output_type -> mediator.v1.GetOrganizationByNameResponse
	70,  // 229: mediator.v1.OrganizationService.DeleteOrganization:output_type -> mediator.v1.DeleteOrganizationResponse
	82,  // 230: mediator.v1.GroupService.CreateGroup:output_type -> mediator.v1.CreateGroupResponse
	85,  // 231: mediator.v1.GroupService.GetGroups:output_type -> mediator.v1.GetGroupsResponse
	83,  // 232: mediator.v1.GroupService.GetGroupByName:output_type -> mediator.v1.GetGroupByNameResponse
	84,  // 233: mediator.v1.GroupService.GetGroupById:output_type -> mediator.v1.GetGroupByIdResponse
	87,  // 234: mediator.v1.GroupService.DeleteGroup:output_type -> mediator.v1.DeleteGroupResponse
	89,  // 235: mediator.v1.RoleService.CreateRoleByOrganization:output_type -> mediator.v1.CreateRoleByOrganizationResponse
	91,  // 236: mediator.v1.RoleService.CreateRoleByGroup:output_type -> mediator.v1.CreateRoleByGroupResponse
	93,  // 237: mediator.v1.RoleService.DeleteRole:output_type -> mediator.v1.DeleteRoleResponse
	96,  // 238: mediator.v1.RoleService.GetRoles:output_type -> mediator.v1.GetRolesResponse
	98,  // 239: mediator.v1.RoleService.GetRolesByGroup:output_type -> mediator.v1.GetRolesByGroupResponse
	100, // 240: mediator.v1.RoleService.GetRoleById:output_type -> mediator.v1.GetRoleByIdResponse
	102, // 241: mediator.v1.RoleService.GetRoleByName:output_type -> mediator.v1.GetRoleByNameResponse
	104, // 242: mediator.v1.UserService.CreateUser:output_type -> mediator.v1.CreateUserResponse
	106, // 243: mediator.v1.UserService.DeleteUser:output_type -> mediator.v1.DeleteUserResponse
	109, // 244: mediator.v1.UserService.GetUsers:output_type -> mediator.v1.GetUsersResponse
	111, // 245: mediator.v1.UserService.GetUsersByOrganization:output_type -> mediator.v1.GetUsersByOrganizationResponse
	113, // 246: mediator.v1.UserService.GetUsersByGroup:output_type -> mediator.v1.GetUsersByGroupResponse
	115, // 247: mediator.v1.UserService.GetUserById:output_type -> mediator.v1.GetUserByIdResponse
	117, // 248: mediator.v1.UserService.GetUserBySubject:output_type -> mediator.v1.GetUserBySubjectResponse
	119, // 249: mediator.v1.UserService.GetUser:output_type -> mediator.v1.GetUserResponse
	121, // 250: mediator.v1.PolicyService.CreatePolicy:output_type -> mediator.v1.CreatePolicyResponse
	123, // 251: mediator.v1.PolicyService.DeletePolicy:output_type -> mediator.v1.DeletePolicyResponse
	125, // 252: mediator.v1.PolicyService.ListPolicies:output_type -> mediator.v1.ListPoliciesResponse
	127, // 253: mediator.v1.PolicyService.GetPolicyById:output_type -> mediator.v1.GetPolicyByIdResponse
	131, // 254: mediator.v1.PolicyService.GetPolicyStatusById:output_type -> mediator.v1.GetPolicyStatusByIdResponse
	133, // 255: mediator.v1.PolicyService.GetPolicyStatusByGroup:output_type -> mediator.v1.GetPolicyStatusByGroupResponse
	143, // 256: mediator.v1.PolicyService.ListRuleTypes:output_type -> mediator.v1.ListRuleTypesResponse
	145, // 257: mediator.v1.PolicyService.GetRuleTypeByName:output_type -> mediator.v1.GetRuleTypeByNameResponse
	147, // 258: mediator.v1.PolicyService.GetRuleTypeById:output_type -> mediator.v1.GetRuleTypeByIdResponse
	149, // 259: mediator.v1.PolicyService.CreateRuleType:output_type -> mediator.v1.CreateRuleTypeResponse
	151, // 260: mediator.v1.PolicyService.UpdateRuleType:output_type -> mediator.v1.UpdateRuleTypeResponse
	153, // 261: mediator.v1.PolicyService.DeleteRuleType:output_type -> mediator.v1.DeleteRuleTypeResponse
	135, // 262: mediator.v1.KeyService.GetPublicKey:output_type -> mediator.v1.GetPublicKeyResponse
	137, // 263: mediator.v1.KeyService.CreateKeyPair:output_type -> mediator.v1.CreateKeyPairResponse
