...
func (m *mockDataSourceFunc) ValidateArgs(_ any) error { return nil }
func (m *mockDataSourceFunc) ValidateUpdate(_ *structpb.Struct) error { return nil }
func (m *mockDataSourceFunc) GetArgsSchema() *structpb.Struct { return nil }
