...
type Querier interface {
	...
	GetArtifactByID(ctx context.Context, id int32) (Artifact, error)
	...
	ListArtifactsByArtifactID(ctx context.Context, arg ListArtifactsByArtifactIDParams) ([]ArtifactVersion, error)
	ListArtifactsByRepoID(ctx context.Context, arg ListArtifactsByRepoIDParams) ([]Artifact, error)
