...
func request_OAuthService_ExchangeCodeForTokenCLI_0(ctx context.Context, marshaler runtime.Marshaler, client OAuthServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CodeExchangeRequestCLI
	var metadata runtime.ServerMetadata
...
func request_OAuthService_ExchangeCodeForTokenWEB_0(ctx context.Context, marshaler runtime.Marshaler, client OAuthServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CodeExchangeRequestWEB
	var metadata runtime.ServerMetadata
...
func RegisterOAuthServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OAuthServiceServer) error {
	...
	mux.Handle("GET", pattern_OAuthService_ExchangeCodeForTokenCLI_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/dev.stacklok.mediator.v1.OAuthService/ExchangeCodeForTokenCLI", runtime.WithHTTPPathPattern("/api/v1/auth/callback/{provider}/cli"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_OAuthService_ExchangeCodeForTokenWEB_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/dev.stacklok.mediator.v1.OAuthService/ExchangeCodeForTokenWEB", runtime.WithHTTPPathPattern("/api/v1/auth/callback/{provider}/web"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterOAuthServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OAuthServiceClient) error {
	...
	mux.Handle("GET", pattern_OAuthService_ExchangeCodeForTokenCLI_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/dev.stacklok.mediator.v1.OAuthService/ExchangeCodeForTokenCLI", runtime.WithHTTPPathPattern("/api/v1/auth/callback/{provider}/cli"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_OAuthService_ExchangeCodeForTokenWEB_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/dev.stacklok.mediator.v1.OAuthService/ExchangeCodeForTokenWEB", runtime.WithHTTPPathPattern("/api/v1/auth/callback/{provider}/web"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
