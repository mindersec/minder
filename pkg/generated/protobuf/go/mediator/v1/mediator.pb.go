...
var file_mediator_v1_mediator_proto_rawDesc = []byte{
	...
	0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xc8, 0x01, 0x0a, 0x12, 0x4f,
...
var file_mediator_v1_mediator_proto_depIdxs = []int32{
	...
	73, // 7: mediator.v1.OrganisationRecord.created_at:type_name -> google.protobuf.Timestamp
	73, // 8: mediator.v1.OrganisationRecord.updated_at:type_name -> google.protobuf.Timestamp
	29, // 9: mediator.v1.GetOrganisationsResponse.organisations:type_name -> mediator.v1.OrganisationRecord
	29, // 10: mediator.v1.GetOrganisationResponse.organisation:type_name -> mediator.v1.OrganisationRecord
	29, // 11: mediator.v1.GetOrganisationByNameResponse.organisation:type_name -> mediator.v1.OrganisationRecord
	73, // 12: mediator.v1.GroupRecord.created_at:type_name -> google.protobuf.Timestamp
	73, // 13: mediator.v1.GroupRecord.updated_at:type_name -> google.protobuf.Timestamp
	73, // 14: mediator.v1.CreateGroupResponse.created_at:type_name -> google.protobuf.Timestamp
	73, // 15: mediator.v1.CreateGroupResponse.updated_at:type_name -> google.protobuf.Timestamp
	42, // 16: mediator.v1.GetGroupByNameResponse.group:type_name -> mediator.v1.GroupRecord
	42, // 17: mediator.v1.GetGroupByIdResponse.group:type_name -> mediator.v1.GroupRecord
	42, // 18: mediator.v1.GetGroupsResponse.groups:type_name -> mediator.v1.GroupRecord
	73, // 19: mediator.v1.CreateRoleResponse.created_at:type_name -> google.protobuf.Timestamp
	73, // 20: mediator.v1.CreateRoleResponse.updated_at:type_name -> google.protobuf.Timestamp
	73, // 21: mediator.v1.RoleRecord.created_at:type_name -> google.protobuf.Timestamp
	73, // 22: mediator.v1.RoleRecord.updated_at:type_name -> google.protobuf.Timestamp
	53, // 23: mediator.v1.GetRolesResponse.roles:type_name -> mediator.v1.RoleRecord
	53, // 24: mediator.v1.GetRoleByIdResponse.role:type_name -> mediator.v1.RoleRecord
	53, // 25: mediator.v1.GetRoleByNameResponse.role:type_name -> mediator.v1.RoleRecord
	73, // 26: mediator.v1.CreateUserResponse.created_at:type_name -> google.protobuf.Timestamp
	73, // 27: mediator.v1.CreateUserResponse.updated_at:type_name -> google.protobuf.Timestamp
	73, // 28: mediator.v1.UserRecord.created_at:type_name -> google.protobuf.Timestamp
	73, // 29: mediator.v1.UserRecord.updated_at:type_name -> google.protobuf.Timestamp
	64, // 30: mediator.v1.GetUsersResponse.users:type_name -> mediator.v1.UserRecord
	64, // 31: mediator.v1.GetUserByIdResponse.user:type_name -> mediator.v1.UserRecord
	64, // 32: mediator.v1.GetUserByUserNameResponse.user:type_name -> mediator.v1.UserRecord
	64, // 33: mediator.v1.GetUserByEmailResponse.user:type_name -> mediator.v1.UserRecord
	0,  // 34: mediator.v1.HealthService.CheckHealth:input_type -> mediator.v1.CheckHealthRequest
	8,  // 35: mediator.v1.GitHubWebhookService.HandleGitHubWebhook:input_type -> mediator.v1.HandleGitHubWebhookRequest
	2,  // 36: mediator.v1.OAuthService.GetAuthorizationURL:input_type -> mediator.v1.GetAuthorizationURLRequest
	4,  // 37: mediator.v1.OAuthService.ExchangeCodeForTokenCLI:input_type -> mediator.v1.ExchangeCodeForTokenCLIRequest
	6,  // 38: mediator.v1.OAuthService.ExchangeCodeForTokenWEB:input_type -> mediator.v1.ExchangeCodeForTokenWEBRequest
	10, // 39: mediator.v1.LogInService.LogIn:input_type -> mediator.v1.LogInRequest
	12, // 40: mediator.v1.LogOutService.LogOut:input_type -> mediator.v1.LogOutRequest
	14, // 41: mediator.v1.AuthVerifyService.Verify:input_type -> mediator.v1.AuthVerifyServiceVerifyRequest
	16, // 42: mediator.v1.VulnerabilitiesService.GetVulnerabilities:input_type -> mediator.v1.GetVulnerabilitiesRequest
	17, // 43: mediator.v1.VulnerabilitiesService.GetVulnerabilityById:input_type -> mediator.v1.GetVulnerabilityByIdRequest
	20, // 44: mediator.v1.SecretsService.GetSecrets:input_type -> mediator.v1.GetSecretsRequest
	22, // 45: mediator.v1.SecretsService.GetSecretById:input_type -> mediator.v1.GetSecretByIdRequest
	24, // 46: mediator.v1.BranchProtectionService.GetBranchProtection:input_type -> mediator.v1.GetBranchProtectionRequest
	27, // 47: mediator.v1.OrganisationService.CreateOrganisation:input_type -> mediator.v1.CreateOrganisationRequest
	32, // 48: mediator.v1.OrganisationService.GetOrganisations:input_type -> mediator.v1.GetOrganisationsRequest
	34, // 49: mediator.v1.OrganisationService.GetOrganisation:input_type -> mediator.v1.GetOrganisationRequest
	36, // 50: mediator.v1.OrganisationService.GetOrganisationByName:input_type -> mediator.v1.GetOrganisationByNameRequest
	30, // 51: mediator.v1.OrganisationService.DeleteOrganisation:input_type -> mediator.v1.DeleteOrganisationRequest
	38, // 52: mediator.v1.GroupService.CreateGroup:input_type -> mediator.v1.CreateGroupRequest
	41, // 53: mediator.v1.GroupService.GetGroups:input_type -> mediator.v1.GetGroupsRequest
	39, // 54: mediator.v1.GroupService.GetGroupByName:input_type -> mediator.v1.GetGroupByNameRequest
	40, // 55: mediator.v1.GroupService.GetGroupById:input_type -> mediator.v1.GetGroupByIdRequest
	47, // 56: mediator.v1.GroupService.DeleteGroup:input_type -> mediator.v1.DeleteGroupRequest
	49, // 57: mediator.v1.RoleService.CreateRole:input_type -> mediator.v1.CreateRoleRequest
	51, // 58: mediator.v1.RoleService.DeleteRole:input_type -> mediator.v1.DeleteRoleRequest
	54, // 59: mediator.v1.RoleService.GetRoles:input_type -> mediator.v1.GetRolesRequest
	56, // 60: mediator.v1.RoleService.GetRoleById:input_type -> mediator.v1.GetRoleByIdRequest
	58, // 61: mediator.v1.RoleService.GetRoleByName:input_type -> mediator.v1.GetRoleByNameRequest
	60, // 62: mediator.v1.UserService.CreateUser:input_type -> mediator.v1.CreateUserRequest
	62, // 63: mediator.v1.UserService.DeleteUser:input_type -> mediator.v1.DeleteUserRequest
	65, // 64: mediator.v1.UserService.GetUsers:input_type -> mediator.v1.GetUsersRequest
	67, // 65: mediator.v1.UserService.GetUserById:input_type -> mediator.v1.GetUserByIdRequest
	69, // 66: mediator.v1.UserService.GetUserByUserName:input_type -> mediator.v1.GetUserByUserNameRequest
	71, // 67: mediator.v1.UserService.GetUserByEmail:input_type -> mediator.v1.GetUserByEmailRequest
	1,  // 68: mediator.v1.HealthService.CheckHealth:output_type -> mediator.v1.CheckHealthResponse
	9,  // 69: mediator.v1.GitHubWebhookService.HandleGitHubWebhook:output_type -> mediator.v1.HandleGitHubWebhookResponse
	3,  // 70: mediator.v1.OAuthService.GetAuthorizationURL:output_type -> mediator.v1.GetAuthorizationURLResponse
	5,  // 71: mediator.v1.OAuthService.ExchangeCodeForTokenCLI:output_type -> mediator.v1.ExchangeCodeForTokenCLIResponse
	7,  // 72: mediator.v1.OAuthService.ExchangeCodeForTokenWEB:output_type -> mediator.v1.ExchangeCodeForTokenWEBResponse
	11, // 73: mediator.v1.LogInService.LogIn:output_type -> mediator.v1.LogInResponse
	13, // 74: mediator.v1.LogOutService.LogOut:output_type -> mediator.v1.LogOutResponse
	15, // 75: mediator.v1.AuthVerifyService.Verify:output_type -> mediator.v1.AuthVerifyServiceVerifyResponse
	19, // 76: mediator.v1.VulnerabilitiesService.GetVulnerabilities:output_type -> mediator.v1.GetVulnerabilitiesResponse
	18, // 77: mediator.v1.VulnerabilitiesService.GetVulnerabilityById:output_type -> mediator.v1.GetVulnerabilityByIdResponse
	21, // 78: mediator.v1.SecretsService.GetSecrets:output_type -> mediator.v1.GetSecretsResponse
	23, // 79: mediator.v1.SecretsService.GetSecretById:output_type -> mediator.v1.GetSecretByIdResponse
	26, // 80: mediator.v1.BranchProtectionService.GetBranchProtection:output_type -> mediator.v1.GetBranchProtectionResponse
	28, // 81: mediator.v1.OrganisationService.CreateOrganisation:output_type -> mediator.v1.CreateOrganisationResponse
	33, // 82: mediator.v1.OrganisationService.GetOrganisations:output_type -> mediator.v1.GetOrganisationsResponse
	35, // 83: mediator.v1.OrganisationService.GetOrganisation:output_type -> mediator.v1.GetOrganisationResponse
	37, // 84: mediator.v1.OrganisationService.GetOrganisationByName:output_type -> mediator.v1.GetOrganisationByNameResponse
	31, // 85: mediator.v1.OrganisationService.DeleteOrganisation:output_type -> mediator.v1.DeleteOrganisationResponse
	43, // 86: mediator.v1.GroupService.CreateGroup:output_type -> mediator.v1.CreateGroupResponse
	46, // 87: mediator.v1.GroupService.GetGroups:output_type -> mediator.v1.GetGroupsResponse
	44, // 88: mediator.v1.GroupService.GetGroupByName:output_type -> mediator.v1.GetGroupByNameResponse
	45, // 89: mediator.v1.GroupService.GetGroupById:output_type -> mediator.v1.GetGroupByIdResponse
	48, // 90: mediator.v1.GroupService.DeleteGroup:output_type -> mediator.v1.DeleteGroupResponse
	50, // 91: mediator.v1.RoleService.CreateRole:output_type -> mediator.v1.CreateRoleResponse
	52, // 92: mediator.v1.RoleService.DeleteRole:output_type -> mediator.v1.DeleteRoleResponse
	55, // 93: mediator.v1.RoleService.GetRoles:output_type -> mediator.v1.GetRolesResponse
	57, // 94: mediator.v1.RoleService.GetRoleById:output_type -> mediator.v1.GetRoleByIdResponse
	59, // 95: mediator.v1.RoleService.GetRoleByName:output_type -> mediator.v1.GetRoleByNameResponse
	61, // 96: mediator.v1.UserService.CreateUser:output_type -> mediator.v1.CreateUserResponse
	63, // 97: mediator.v1.UserService.DeleteUser:output_type -> mediator.v1.DeleteUserResponse
	66, // 98: mediator.v1.UserService.GetUsers:output_type -> mediator.v1.GetUsersResponse
	68, // 99: mediator.v1.UserService.GetUserById:output_type -> mediator.v1.GetUserByIdResponse
	70, // 100: mediator.v1.UserService.GetUserByUserName:output_type -> mediator.v1.GetUserByUserNameResponse
	72, // 101: mediator.v1.UserService.GetUserByEmail:output_type -> mediator.v1.GetUserByEmailResponse
