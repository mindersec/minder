...
var file_mediator_v1_mediator_proto_rawDesc = []byte{
	...
	0x68, 0x50, 0x72, 0x6f, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0x79, 0x0a, 0x0d,
	...
	0x2f, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x32, 0xa1, 0x01, 0x0a, 0x14, 0x47, 0x69, 0x74, 0x48,
	0x75, 0x62, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x88, 0x01, 0x0a, 0x13, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x47, 0x69, 0x74, 0x48, 0x75,
	0x62, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x12, 0x27, 0x2e, 0x6d, 0x65, 0x64, 0x69, 0x61,
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2f, 0x68, 0x6f, 0x6f, 0x6b, 0x32, 0xdd, 0x03, 0x0a, 0x0c,
	...
	0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x7d, 0x2f, 0x77, 0x65, 0x62, 0x32, 0x6d, 0x0a, 0x0c, 0x4c,
	0x6f, 0x67, 0x49, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x5d, 0x0a, 0x05, 0x4c,
	...
	0x61, 0x75, 0x74, 0x68, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x32, 0x72, 0x0a, 0x0d, 0x4c, 0x6f,
	0x67, 0x4f, 0x75, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x61, 0x0a, 0x06, 0x4c,
	...
	0x76, 0x31, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x6c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x32, 0x99,
	0x01, 0x0a, 0x11, 0x41, 0x75, 0x74, 0x68, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x83, 0x01, 0x0a, 0x06, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x12,
	0x2b, 0x2e, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x75,
	0x74, 0x68, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x56,
	0x65, 0x72, 0x69, 0x66, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2c, 0x2e, 0x6d,
	...
	0x31, 0x2f, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x32, 0xa6,
	...
	0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_mediator_v1_mediator_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
...
var file_mediator_v1_mediator_proto_depIdxs = []int32{
	27, // 0: mediator.v1.GetVulnerabilityByIdResponse.scanned_at:type_name -> google.protobuf.Timestamp
	27, // 1: mediator.v1.GetVulnerabilityByIdResponse.created_at:type_name -> google.protobuf.Timestamp
	...
	0,  // 5: mediator.v1.HealthService.CheckHealth:input_type -> mediator.v1.CheckHealthRequest
	8,  // 6: mediator.v1.GitHubWebhookService.HandleGitHubWebhook:input_type -> mediator.v1.HandleGitHubWebhookRequest
	2,  // 7: mediator.v1.OAuthService.GetAuthorizationURL:input_type -> mediator.v1.GetAuthorizationURLRequest
	4,  // 8: mediator.v1.OAuthService.ExchangeCodeForTokenCLI:input_type -> mediator.v1.ExchangeCodeForTokenCLIRequest
	6,  // 9: mediator.v1.OAuthService.ExchangeCodeForTokenWEB:input_type -> mediator.v1.ExchangeCodeForTokenWEBRequest
	10, // 10: mediator.v1.LogInService.LogIn:input_type -> mediator.v1.LogInRequest
	12, // 11: mediator.v1.LogOutService.LogOut:input_type -> mediator.v1.LogOutRequest
	14, // 12: mediator.v1.AuthVerifyService.Verify:input_type -> mediator.v1.AuthVerifyServiceVerifyRequest
	16, // 13: mediator.v1.VulnerabilitiesService.GetVulnerabilities:input_type -> mediator.v1.GetVulnerabilitiesRequest
	17, // 14: mediator.v1.VulnerabilitiesService.GetVulnerabilityById:input_type -> mediator.v1.GetVulnerabilityByIdRequest
	20, // 15: mediator.v1.SecretsService.GetSecrets:input_type -> mediator.v1.GetSecretsRequest
	22, // 16: mediator.v1.SecretsService.GetSecretById:input_type -> mediator.v1.GetSecretByIdRequest
	24, // 17: mediator.v1.BranchProtectionService.GetBranchProtection:input_type -> mediator.v1.GetBranchProtectionRequest
	1,  // 18: mediator.v1.HealthService.CheckHealth:output_type -> mediator.v1.CheckHealthResponse
	9,  // 19: mediator.v1.GitHubWebhookService.HandleGitHubWebhook:output_type -> mediator.v1.HandleGitHubWebhookResponse
	3,  // 20: mediator.v1.OAuthService.GetAuthorizationURL:output_type -> mediator.v1.GetAuthorizationURLResponse
	5,  // 21: mediator.v1.OAuthService.ExchangeCodeForTokenCLI:output_type -> mediator.v1.ExchangeCodeForTokenCLIResponse
	7,  // 22: mediator.v1.OAuthService.ExchangeCodeForTokenWEB:output_type -> mediator.v1.ExchangeCodeForTokenWEBResponse
	11, // 23: mediator.v1.LogInService.LogIn:output_type -> mediator.v1.LogInResponse
	13, // 24: mediator.v1.LogOutService.LogOut:output_type -> mediator.v1.LogOutResponse
	15, // 25: mediator.v1.AuthVerifyService.Verify:output_type -> mediator.v1.AuthVerifyServiceVerifyResponse
	19, // 26: mediator.v1.VulnerabilitiesService.GetVulnerabilities:output_type -> mediator.v1.GetVulnerabilitiesResponse
	18, // 27: mediator.v1.VulnerabilitiesService.GetVulnerabilityById:output_type -> mediator.v1.GetVulnerabilityByIdResponse
	21, // 28: mediator.v1.SecretsService.GetSecrets:output_type -> mediator.v1.GetSecretsResponse
	23, // 29: mediator.v1.SecretsService.GetSecretById:output_type -> mediator.v1.GetSecretByIdResponse
	26, // 30: mediator.v1.BranchProtectionService.GetBranchProtection:output_type -> mediator.v1.GetBranchProtectionResponse
