...
func NewRuleRemediator(rt *pb.RuleType, provider provinfv1.Provider) (engif.Action, error) {
	...
	case rest.RemediateType:
		...
		return rest.NewRestRemediate(ActionType, rem.GetRest(), provider)
	...
	case gh_branch_protect.RemediateType:
		...
		return gh_branch_protect.NewGhBranchProtectRemediator(ActionType, rem.GetGhBranchProtection(), provider)
	...
	case pull_request.RemediateType:
		...
		return pull_request.NewPullRequestRemediate(ActionType, rem.GetPullRequest(), provider)
	}
