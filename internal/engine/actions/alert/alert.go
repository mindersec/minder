...
func NewRuleAlert(rt *pb.RuleType, provider provinfv1.Provider) (engif.Action, error) {
	...
	case security_advisory.AlertType:
		...
		return security_advisory.NewSecurityAdvisoryAlert(ActionType, rt.GetSeverity(), alertCfg.GetSecurityAdvisory(), provider)
	}
