...
INSERT INTO rule_type (
    ...
    $7,
    $8
) RETURNING id, name, provider, project_id, description, guidance, definition, created_at, updated_at, severity_value, provider_id, subscription_id, display_name, state
`
...
SELECT id, name, provider, project_id, description, guidance, definition, created_at, updated_at, severity_value, provider_id, subscription_id, display_name, state FROM rule_type WHERE id = $1
`
...
SELECT id, name, provider, project_id, description, guidance, definition, created_at, updated_at, severity_value, provider_id, subscription_id, display_name, state FROM rule_type WHERE  project_id = ANY($1::uuid[]) AND lower(name) = lower($2)
`
...
SELECT rt.id, rt.name, rt.provider, rt.project_id, rt.description, rt.guidance, rt.definition, rt.created_at, rt.updated_at, rt.severity_value, rt.provider_id, rt.subscription_id, rt.display_name, rt.state FROM rule_type AS rt
...
SELECT id, name, provider, project_id, description, guidance, definition, created_at, updated_at, severity_value, provider_id, subscription_id, display_name, state FROM rule_type WHERE project_id = $1
`
