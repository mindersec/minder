...
// Source: github.com/stacklok/minder/internal/providers (interfaces: ProviderService,GitHubClientService)
//
...
// MockGitHubClientService is a mock of GitHubClientService interface.
type MockGitHubClientService struct {
	ctrl     *gomock.Controller
	recorder *MockGitHubClientServiceMockRecorder
}

// MockGitHubClientServiceMockRecorder is the mock recorder for MockGitHubClientService.
type MockGitHubClientServiceMockRecorder struct {
	mock *MockGitHubClientService
}

// NewMockGitHubClientService creates a new mock instance.
func NewMockGitHubClientService(ctrl *gomock.Controller) *MockGitHubClientService {
	mock := &MockGitHubClientService{ctrl: ctrl}
	mock.recorder = &MockGitHubClientServiceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockGitHubClientService) EXPECT() *MockGitHubClientServiceMockRecorder {
	return m.recorder
}

// GetInstallation mocks base method.
func (m *MockGitHubClientService) GetInstallation(arg0 context.Context, arg1 int64, arg2 string) (*github.Installation, *github.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGitHubClientServiceMockRecorder) GetInstallation(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetInstallation", reflect.TypeOf((*MockGitHubClientService)(nil).GetInstallation), arg0, arg1, arg2)
}

// GetUserIdFromToken mocks base method.
func (m *MockGitHubClientService) GetUserIdFromToken(arg0 context.Context, arg1 *oauth2.Token) (*int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGitHubClientServiceMockRecorder) GetUserIdFromToken(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserIdFromToken", reflect.TypeOf((*MockGitHubClientService)(nil).GetUserIdFromToken), arg0, arg1)
}

// ListUserInstallations mocks base method.
func (m *MockGitHubClientService) ListUserInstallations(arg0 context.Context, arg1 *oauth2.Token) ([]*github.Installation, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGitHubClientServiceMockRecorder) ListUserInstallations(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListUserInstallations", reflect.TypeOf((*MockGitHubClientService)(nil).ListUserInstallations), arg0, arg1)
}
