...
//
//	mockgen -package mockghhook -destination internal/repositories/github/webhooks/mock/service.go github.com/stacklok/minder/internal/repositories/github/webhooks WebhookManager
//
