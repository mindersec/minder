...
var file_internal_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2a, 0x72, 0x0a,
...
var file_internal_proto_goTypes = []any{
	...
	(*PrDependencies_ContextualDependency)(nil),           // 4: internal.PrDependencies.ContextualDependency
	(*PrDependencies_ContextualDependency_FilePatch)(nil), // 5: internal.PrDependencies.ContextualDependency.FilePatch
	(*PrContents_File)(nil),                               // 6: internal.PrContents.File
	(*PrContents_File_Line)(nil),                          // 7: internal.PrContents.File.Line
	(*v1.PullRequest)(nil),                                // 8: minder.v1.PullRequest
}
var file_internal_proto_depIdxs = []int32{
	0, // 0: internal.Dependency.ecosystem:type_name -> internal.DepEcosystem
	8, // 1: internal.PrDependencies.pr:type_name -> minder.v1.PullRequest
	4, // 2: internal.PrDependencies.deps:type_name -> internal.PrDependencies.ContextualDependency
	8, // 3: internal.PrContents.pr:type_name -> minder.v1.PullRequest
	6, // 4: internal.PrContents.files:type_name -> internal.PrContents.File
	1, // 5: internal.PrDependencies.ContextualDependency.dep:type_name -> internal.Dependency
	5, // 6: internal.PrDependencies.ContextualDependency.file:type_name -> internal.PrDependencies.ContextualDependency.FilePatch
	7, // 7: internal.PrContents.File.patch_lines:type_name -> internal.PrContents.File.Line
