...
const config = {
  title: 'Mediator Site',
  tagline: 'Landing page for Mediator',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/stacklok/mediator/tree/main/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {to: 'https://www.stacklok.com/blog', label: 'Blog', position: 'left'},
          {
